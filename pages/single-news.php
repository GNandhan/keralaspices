						...
						<nav class="main-menu">
							<ul>
								...
								<!-- <li><a href="news.php">News</a>
									<ul class="sub-menu">
										<li><a href="news.php">News</a></li>
										<li class="current-list-item"><a href="single-news.php">Single News</a></li>
									</ul>
								</li> -->
								<li><a href="contact.php">Contact</a></li>
							...
							<div class="comment-list">
								<div class="single-comment-body">
									...
									<div class="comment-text-body">
										<h4>Hemand S Prabakaren <span class="comment-date">October 18, 2023</span> <a href="#">reply</a></h4>
									...
									<div class="single-comment-body child">
										...
										<div class="comment-text-body">
											<h4>Simon Soe <span class="comment-date">October 6, 2023</span> <a href="#">reply</a></h4>
								...
								<div class="single-comment-body">
									...
									<div class="comment-text-body">
										<h4>Ajith <span class="comment-date">September 22, 2023</span> <a href="#">reply</a></h4>
										<p>Nunc risus ex, tempus quis purus ac, tempor consequat ex. Vivamus sem magna, maximus at est id, maximus aliquet nunc. Suspendisse lacinia velit a eros porttitor, in interdum ante faucibus Suspendisse lacinia velit a eros porttitor, in interdum ante faucibus.</p>
									</div>
								</div>
							</div>
